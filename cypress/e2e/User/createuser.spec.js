...
describe("createuser", () => {
  ...
  it("Should be able to create a user when ToS is accepted", () => {
    ...
    cy.getByTestId(TEST_ID_CREATE_USER.citySelect, { timeout: 10000 }).should("not.be.disabled");
    ...
    cy.getByTestId(TEST_ID_CREATE_USER.validationErrorContainer, { timeout: 10000 })
      .should("be.visible")
