...
const Login = () => {
  ...
  return (
    <GoogleOAuthProvider clientId={GOOGLE_CLIENT_ID}>
      ...
      <div className="flex flex-col items-center justify-center w-full min-h-[calc(100vh-64px)] bg-[#1a1a1a]">
        {/* Main Edge-to-Edge Container */}
        <div className="w-full h-full min-h-[calc(100vh-64px)] flex flex-row overflow-hidden bg-[#222222]">
